...
PROJECT_NAME = "farmer-assistant"
HF_USER = "naveenng10" 
DATASET_NAME = 'naveenng10/farmer-assistant-query-data'
...
class FinetuneModel:
    ...
    def load_hf_dataset(self):
        ...
        self.train = train.select(range(60000))
    ...
    def set_data_collector(self):
        #  Teach the model to predict the token(s) after "Answer is:" and tell model not to train the model to predict the question.
        response_template = "Answer is:"
...
if __name__ == "__main__":
    FinetuneModel().start_training()


    ##############
    # Goole colab notebook link : https://colab.research.google.com/drive/1Eb_HCFPhgB2zv0vTQoFwzQuTm-hBc8kf#scrollTo=U4caN9CogOKx
    ###############